    ...
    <header className="header">
      <Fade>
        ...
        <ul className="hidden text-theme-blue tracking-widest items-center lg:flex flex-row mt-0">
          ...
          <li>
            <Button
              className="text-lg mx-auto ml-3 px-6 py-2 bg-theme-blue text-white rounded-full border-2 border-theme-blue hover:bg-dark-theme-blue border-blue-800 transition duration-200"
              type="link"
        ...
        <Fade>
          <ul className="z-50 flex flex-col text-theme-blue tracking-widest my-6 absolute bg-white w-full border-b-2 border-gray-300 lg:hidden">
            ...
            <li className="mx-auto my-9 bg-white">
              <Button
                className="mx-auto px-5 py-2 bg-theme-blue text-white rounded-full border-2 border-theme-blue hover:bg-dark-theme-blue border-blue-800 transition duration-200"
                type="link"
                href="/discuss-project"
              >
                Contact
